...
// NPIV regression
// you can turn the 'decreasing option' by deleting decreasing in the below line
npivmonotone y x z, power_exp(2) power_inst(3) num_exp(4) num_inst(4) pctile(1) decreasing
