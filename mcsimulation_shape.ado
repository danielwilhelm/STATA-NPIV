...
// and compute npiv estimate with a increasing shape restriction

program define mcsimulation_shape, eclass
...
// NPIV regression 
npiv y x z, power_exp(2) power_inst(3) num_exp(4) num_inst(4) pctile(1) increasing
